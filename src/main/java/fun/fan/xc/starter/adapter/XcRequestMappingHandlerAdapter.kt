...
class XcRequestMappingHandlerAdapter : RequestMappingHandlerAdapter() {
    ...
    private fun addCustomerArgumentResolvers(
        baseArgumentResolvers: List<HandlerMethodArgumentResolver>?,
        xcArgumentResolvers: List<HandlerMethodArgumentResolver>
