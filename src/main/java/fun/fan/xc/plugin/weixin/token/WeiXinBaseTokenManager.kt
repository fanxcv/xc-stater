 ...
 */
abstract class WeiXinBaseTokenManager : WeiXinTokenManager, InitializingBean {
  protected val log: Logger = LoggerFactory.getLogger(this::class.java)

  class TokenEntity : WeiXinTokenManager.BaseTokenEntity() {
    /**
     * Token更新次数
     */
  ...
  /**
   * 每个类型的Token都需要实现自己的方法
   */
  abstract fun doRefresh(entity: TokenEntity)
}
